...
class LanguagesControllerTest < ActionController::TestCase
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post :create, language: { description: @language.description, how_to: @language.how_to, name: @language.name }
    end
  ...
  test "should update language" do
    put :update, id: @language, language: { description: @language.description, how_to: @language.how_to, name: @language.name }
    assert_redirected_to language_path(assigns(:language))
  end
